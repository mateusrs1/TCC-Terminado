    ...
    <div class="sidebar">
        <div class="profile">
            <a href="perfil" style="text-decoration: none;">
                ...
                <p class="tooltip">
                    ...
                    <br>
                    XP Atual: <?php echo $_SESSION['xp']; ?>
                    <br>
                    Faltam <?php echo $usuario['xp_para_proximo_nivel']; ?> XP para o próximo nível
                    <span class="tooltiptext">
                        Você ganha XP ao comprar no nosso sistema. Quando atingir 100 XP a mais, seu nível aumentará
                        automaticamente!
                    </span>
                </p>
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="<?php echo INCLUDE_PATH; ?>carrinho"><i class="fa-solid fa-cart-shopping"></i> Carrinho</a>
                </li>
                <li><a href="<?php echo INCLUDE_PATH; ?>pedidos"><i class="fa-regular fa-calendar-check"></i>
                        Pedidos</a></li>
            </ul>
        </nav>
